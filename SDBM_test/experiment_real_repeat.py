...
def run_experiment(name, classifier_names, classifier_paths, tt_number, epochs_dataset, classes_mult, iteration):

    output_dir = f'../data/experiment_output/{name}/train_test_{tt_number}/iteration_{iteration}'
    ...
    for classifier_path, clf_name in zip(classifier_paths, classifier_names):
        ...
        if clf_name == "LogisticRegression":
            ...
            #     Dense(n_classes, activation='softmax')
            # ])
            clf = load_model('../data/experiment_output/reduced_mnist_data/train_test_1/iteration_0/MLP.h5')
...
if __name__ == "__main__":
    for tt_number in tt_numbers:
        for iteration in range(5):
            run_experiment(name, classifier_names, classifier_paths, tt_number, epochs_dataset, classes_mult, iteration)