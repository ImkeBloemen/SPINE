...
class CounterfactualExamples:
    ...
    def __init__(self, data_interface=None, intermediate_cfs=None, gradients=None, losses=None, intermediate_predictions=None, iterations=None, final_cfs_df=None, test_instance_df=None,
        ...
        self.intermediate_cfs = intermediate_cfs
    ...
    def to_json(self, serialization_version):
        ...
        if serialization_version == _SchemaVersions.V1:
            obj = {
                ...
                "intermediate_cfs": self.intermediate_cfs,
                "gradients": self.gradients,  # Add intermediate points to the serialized output
                "losses": self.losses,
                "intermediate_predictions": self.intermediate_predictions,
    ...
    def from_json(cf_example_json_str):
        ...
        if cf_example_dict.get(_DiverseCFV1SchemaConstants.TEST_INSTANCE_DF) is not None:
            ...
            intermediate_cfs = cf_example_dict.get("intermediate_cfs", None)  # Retrieve intermediate points
            gradients = cf_example_dict.get("gradients", None)
            losses = cf_example_dict.get("losses", None)
            intermediate_predictions = cf_example_dict.get("intermediate_predictions", None)  # Retrieve intermediate points
            iterations = cf_example_dict.get('iterations', None)
            ...
            gradients = cf_example_dict.get("gradients", None)
            losses = cf_example_dict.get("losses", None)
            intermediate_predictions = cf_example_dict.get("intermediate_predictions", None)
            iterations = cf_example_dict.get('iterations', None)
