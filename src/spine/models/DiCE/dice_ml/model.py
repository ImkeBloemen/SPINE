...
def decide(backend):
    ...
    if backend == BackEndTypes.Sklearn:
        ...
        from VAE_DBS.models.DiCE.dice_ml.model_interfaces.keras_tensorflow_model import \
        ...
        from VAE_DBS.models.DiCE.dice_ml.model_interfaces.pytorch_model import PyTorchModel
        return PyTorchModel
