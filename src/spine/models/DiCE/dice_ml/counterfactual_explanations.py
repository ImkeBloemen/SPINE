...
class CounterfactualExplanations:
    ...
    """
    def __init__(self, cf_examples_list, intermediate_cfs, gradients, losses, intermediate_predictions, iterations,
        ...
        self._intermediate_cfs = intermediate_cfs
        self._gradients = None
        self._losses = None
        self._intermediate_predictions = intermediate_predictions
    ...
    @property
    def intermediate_cfs(self):
        """Return the intermediate counterfactuals."""
        return self._intermediate_cfs
    
    @property
    def gradients(self):
        """Return the intermediate counterfactual gradients."""
        return self._gradients
    
    @property
    def losses(self):
        """Return the intermediate counterfactual losses."""
        return self._losses
    
    @property
    def intermediate_predictions(self):
        """Return the intermediate predictions."""
    ...
    def to_json(self):
        ...
        if serialization_version == _SchemaVersions.V1:
            ...
            entire_dict = {
                ...
                "intermediate_cfs": self._intermediate_cfs,  # Include intermediate counterfactuals
                "gradients": self._gradients,
                "losses": self._losses,
                "intermediate_predictions": self._intermediate_predictions,
    ...
    def from_json(json_str):
        ...
        if _CommonSchemaConstants.METADATA in json_dict:
            ...
            if version == _SchemaVersions.V1:
                ...
                intermediate_cfs = json_dict.get("intermediate_cfs", None)  # Load intermediate points
                gradients = json_dict.get("gradients", None)  # Load gradients
                losses = json_dict.get("losses", None)  # Load losses
                intermediate_predictions = json_dict.get("intermediate_predictions", None)  # Load intermediate predictions
                iterations = json_dict.get("iterations", None)  # Load iterations
                ...
                return CounterfactualExplanations(
                        ...
                        intermediate_cfs=intermediate_cfs,  # Assign intermediate_cfs
                        gradients=gradients,
                        losses=losses,
