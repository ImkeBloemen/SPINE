...
if __name__ == '__main__':
    ...
    for tt_number in tt_numbers:
        run_experiment(model_path='evaluation/lamp/reduced_mnist_data',
                    tt_number=tt_number,
                    input_path=f'../../../experiment_output/lamp/reduced_mnist_data_new_eval/train_test_{tt_number}', 
                    dataset_name='reduced_mnist_data', 
                    model_names= ['MLP'],  #['LogisticRegression', 'MLP'],#['underfit_model','balanced_model', 'overfit_model'], #['MLP_model'], #['LogisticRegression','MLP'], #'underfit_model', , 'overfit_model'
                    outcome_name='label', 
                    output_path_train_test=f'../../../experiment_output/lamp/reduced_mnist_data_filter/train_test_{tt_number}', 
                    test_input_path=f'../../../experiment_input/lamp/reduced_mnist_data/train_test_{tt_number}')